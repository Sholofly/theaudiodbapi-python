...
from theaudiodbapi.models import TheAudioDBApiEnvironment, TheAudioDBSettings
logging.basicConfig(level=logging.INFO)
mylogger = logging.getLogger()

async def test():
    """Function to test TheAudioDBAPI integration"""
    gc_settings = TheAudioDBSettings()
    api = TheAudioDBApi(api_key='3d4965cffdmshab7d6011a95becep1dd253jsnd57e33c15185')
    await _update(api)
